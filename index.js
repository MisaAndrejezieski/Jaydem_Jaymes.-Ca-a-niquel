function multiplicador() {
    ...
    var pesos = [0.05, 0.25, 0.05, 0.05, 0.05, 0.05, 0.05, 0.04, 0.04, 0.04, 0.04, 0.02, 0.03, 0.03, 0.03, 0.03, 0.03, 0.03];
    var multiplicadores = [1.5, 0.5, 1.5, 1.5, 1.5, 1.5, 2, 3, 4, 5, 6, 7, 8, 8, 8, 9, 9, 10];
    var resultados = [];
